...
import { Stratagem, fetchStratagemsFor } from "./Stratagems";
...
class Roster extends React.Component<Props> {
    ...
    constructor(props:Props) {
        ...
        fetchStratagemsFor(this.props.Data.Faction, this.props.Data.Detachment).then((strats)=>{
            console.log(strats);
            this.state.DetachmentStratagems = strats;
        });
